  ...
  String get iconSvgString {
    switch (this) {
      ...
      case TrackerType.simkl:
        ...
        ''';
      case TrackerType.trakt:
        return '''
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path fill="#ED1C24" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.856 14.885l-1.848 1.848-4.008-4.008-4.008 4.008-1.848-1.848 4.008-4.008-4.008-4.008 1.848-1.848 4.008 4.008 4.008-4.008 1.848 1.848-4.008 4.008 4.008 4.008z"/>
        </svg>
        ''';
